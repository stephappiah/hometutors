...
$(document).ready(function(){
    ...
    const colorStyle = {
        ...
        individualChips = $('#id_tutor_profile-class_type_0'),
        groupChips = $('#id_tutor_profile-class_type_1'),
        onlineChips = $('#id_tutor_profile-class_type_2');
    ...
    const preschool = $('#id_interest-teach_levels_0'),
          primlevel = $('#id_interest-teach_levels_1'),
          jhighlevel = $('#id_interest-teach_levels_2'),
          senhighlevel = $('#id_interest-teach_levels_3');
    ...
    const wrt = $('#id_interest-courses_subjects_0'),
          red = $('#id_interest-courses_subjects_1'),
          num = $('#id_interest-courses_subjects_2'),
          eng = $('#id_interest-courses_subjects_3'),
          mat = $('#id_interest-courses_subjects_4'),
          scn = $('#id_interest-courses_subjects_5'),
          lit = $('#id_interest-courses_subjects_6'),
          eco = $('#id_interest-courses_subjects_7'),
          his = $('#id_interest-courses_subjects_8'),
          gov = $('#id_interest-courses_subjects_9'),
          geo = $('#id_interest-courses_subjects_10'),
          rst = $('#id_interest-courses_subjects_11'),
          fre = $('#id_interest-courses_subjects_12'),
          bio = $('#id_interest-courses_subjects_13'),
          phy = $('#id_interest-courses_subjects_14'),
          che = $('#id_interest-courses_subjects_15'),
          grp = $('#id_interest-courses_subjects_16'),
          pmk = $('#id_interest-courses_subjects_17'),
          bsk = $('#id_interest-courses_subjects_18'),
          cer = $('#id_interest-courses_subjects_19'),
          scp = $('#id_interest-courses_subjects_20'),
          jew = $('#id_interest-courses_subjects_21'),
          ltw = $('#id_interest-courses_subjects_22'),
          gka = $('#id_interest-courses_subjects_23'),
          bsm = $('#id_interest-courses_subjects_24'),
          acc = $('#id_interest-courses_subjects_25'),
          prc = $('#id_interest-courses_subjects_26'),
          bum = $('#id_interest-courses_subjects_27'),
          emt = $('#id_interest-courses_subjects_28'),
          mil = $('#id_interest-courses_subjects_29'),
          fdn = $('#id_interest-courses_subjects_30'),
          txt = $('#id_interest-courses_subjects_31');
