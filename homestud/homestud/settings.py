"""
Django settings for homestud project.
...
ACCOUNT_SIGNUP_PASSWORD_ENTER_TWICE = False # set to true or remove in production 
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'homestud/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
