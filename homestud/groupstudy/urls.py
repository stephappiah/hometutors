...
from .views import GroupClassView, GroupClassUpdate, GroupClassDelete, GroupClassList, ShowGroupClass, FilterSearch
...
urlpatterns = [
    ...
    path('class/filter', FilterSearch, name='filter'),
